package com.backend.rentalBusiness.rentalTransaction.service.impl;
...
import com.backend.rentalBusiness.lateFee.repository.LateFeeRepository;
...
import com.backend.rentalBusiness.rentalTransaction.dto.request.CreateRentalLineRequest;
import com.backend.rentalBusiness.rentalTransaction.dto.request.CreateRentalTransactionRequest;
import com.backend.rentalBusiness.rentalTransaction.dto.response.RemainingAssetResponse;
import com.backend.rentalBusiness.rentalTransaction.dto.response.RentalSummaryResponse;
import com.backend.rentalBusiness.rentalTransaction.dto.response.RentalTimelineResponse;
...
import com.backend.rentalBusiness.rentalTransaction.mapper.RentalTransactionMapper;
import com.backend.rentalBusiness.rentalTransaction.repository.RentalTransactionRepository;
import com.backend.rentalBusiness.rentalTransaction.service.RentalTransactionService;
...
public List<RentalTimelineResponse> getTimeline(UUID rentalId) {
    ...
    // Damage reports from return records
    for (RentalReturn ret : returns) {
        if ("DAMAGED".equalsIgnoreCase(ret.getConditionOnReturn())) {
            timeline.add(new RentalTimelineResponse(
                    ret.getCreatedAt(),
                    "DAMAGE_REPORTED",
                    "Damage reported: " + ret.getDamageNotes()
            ));
        }
    }
